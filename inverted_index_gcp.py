...
class MultiFileReader:
    ...
    def read(self, locs, n_bytes, blob_name, bucket_name='abody'):
        b = []
        for f_name, offset in locs:
            if f_name not in self._open_files:
                GCSFS = gcsfs.GCSFileSystem()
                self._open_files[f_name] = GCSFS.open(f'gs://abody/{blob_name}/{f_name}', 'rb')
            #             if f_name not in self._open_files:
...
class InvertedIndex:
    ...
    def read_posting_list(self, w, blob_name, bucket_name='abody'):
